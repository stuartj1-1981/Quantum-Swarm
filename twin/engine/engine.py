...
It only depends on twin.signal and sibling modules.
...
from twin.signal import InputBlock, OutputBlock
...
class ThermalEngine:
    ...
    def __init__(self, config: Dict):
        ...
        from twin.cop_models.cop_model import create_cop_model
