...
def run_single_sim(args: Tuple) -> Dict[str, Any]:
    ...
    try:
        ...
        if strategy not in ("stock", "stock_weather_comp", "hp_wc") and not strategy.startswith("hp_fixed_"):
            from ..pipeline import build_pipeline, run_cycle
            from ..debounce import ControlDebouncer
            from ..rl_model import ActorCritic, AdaptiveStateBuilder
        ...
        for cycle in range(total_cycles):
            ...
            if strategy == "stock":
                ...
                from ..signal import OutputBlock
                ...
                from ..signal import OutputBlock
                from .wc_curves import wc_flow_temp, WC_CURVES
...
def run_batch(
    ...
    """
    from .wc_curves import WC_MODERATE_CURVES
...
def main():
    ...
    if wc_curves and "all" in wc_curves:
        from .wc_curves import WC_ALL_CURVES
